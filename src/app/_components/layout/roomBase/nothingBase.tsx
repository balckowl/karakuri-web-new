      ...
      {currentRoom === "cafeteria" ?
          <div>
            ...
            >
              <div className="h-full p-6">
                <div className="absolute font-bold text-xl">/floor1/cafeteria</div>
              </div>
            </motion.div>
        ...
        : currentRoom === "corridor" ?
          <div>
            ...
            >
              <div className="h-full p-6">
                <div className="absolute font-bold text-xl">/floor2/corridor</div>
              </div>
            </motion.div>
        ...
        : currentRoom === "restroom" &&
          <div>
            ...
            >
              <div className="h-full p-6">
                <div className="absolute font-bold text-xl">/floor3/restroom</div>
              </div>
            </motion.div>
