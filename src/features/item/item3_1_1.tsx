...
export function Item3_1_1() {
  return (
    <>
      <div className="mx-auto flex w-full h-full flex-row items-center justify-center gap-4 px-8 py-20 dark:bg-black">
        <Card title="0100" icon={<AceternityIcon />}>
          <CanvasRevealEffect
            animationSpeed={5.1}
            containerClassName="bg-emerald-900"
          />
        </Card>
        <Card title="0000" icon={<AceternityIcon />}>
          <CanvasRevealEffect
            animationSpeed={3}
...
const AceternityIcon = () => {
  return (
    <svg
      ...
      className="size-10 text-black group-hover/canvas-card:text-white dark:text-white "
    >
      {/* <path
