  ...
  const entranceTextList = useMemo(() => {
    return {
      0: [
        ...
        ["k-15", "..."],
        ["you", "だ、だれ...?"],
        ["k-15", "私はからくりAIのk-15といいます。どうやらあなたはこの館に閉じ込められたようです。"],
        ["you", "なんで閉じ込められたの？"],
        ["k-15", "分かりません。ただ、この館から脱出をしない限りは元の世界に帰れなさそうですね。"],
        ["you", "..."],
        ["k-15", "しかし、安心してください。私があなたの脱出をサポートします。"],
        ["you", "ありがとう。"],
        ["k-15", "とりあえず、行ける部屋を探索してみてはいかがでしょうか？"],
        ["you", "わかった。"],
      ],
      1: [
